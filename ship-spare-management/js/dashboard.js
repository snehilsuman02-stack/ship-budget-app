...
export function renderDashboard(container, state) {
  ...
  container.innerHTML = `
    <section class="kpi-grid">
      ...
      <article class="card kpi-card"><h3>Stock Value (₹)</h3><p class="kpi-value">${formatCurrency(kpi.stockValue, "INR")}</p><p class="kpi-meta">Quantity x unit cost in Indian rupees</p></article>
